...
public class downloadReport extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.print("<button class='form-submit' onclick='downloadReport()'><i class='fa fa-download'></i><a href='downloaded_report/2_report-answer.txt' download>Download</a></button>");
